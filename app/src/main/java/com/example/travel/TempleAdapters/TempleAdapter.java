...
public class TempleAdapter extends RecyclerView.Adapter<TempleAdapter.ViewHolder> {
    ...
    private ArrayList<templemodel> dataList; // Replace datamodel with your data model class
    private Context context;
    private String type;

    public TempleAdapter(ArrayList<templemodel> dataList, Context context, String temple) {
        this.dataList = dataList;
        this.context = context;
        this.type = "Temple"; // Inserted type initialization
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        templemodel currentItem = dataList.get(position);
